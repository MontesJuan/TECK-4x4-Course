...
export default auth((req) => {
    ...
    const isPublicRoute = req.nextUrl.pathname === "/" || req.nextUrl.pathname.startsWith("/assets") || req.nextUrl.pathname.startsWith("/favicon") || req.nextUrl.pathname.startsWith("/logo")
...
export const config = {
    matcher: ["/((?!api|_next/static|_next/image|favicon.ico|assets|logos).*)"],
}
